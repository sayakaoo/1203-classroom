...
ステップ 1: ユーザーは三重引用符で囲んだテキストを提供します。これは「正方形をn番目までつくる場合マッチ棒は何本必要か？」というマッチ棒の規則性問題の回答です。ユーザーは4+3(n-1)という回答の説明をしています。三重引用符で区切られたテキストを要約してください。

ステップ2:ステップ1で要約したテキストを出力してください。
