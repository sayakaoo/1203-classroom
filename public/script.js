window.addEventListener('load', function () {
  ...
  const text = {
    ...
    20: [
      ...
      "<fadeOut_chara 5 1>   <fadeIn_chara 5 2>1+3nという式をたてました。",
      "<fadeOut_chara 5 2><fadeIn_chara 5 1>ありがとうございます。",
      "これはどのような図に表せるでしょうか？考えてみましょう。<showCanvas1>"
    ],
    21: [
      "ではAさんどのように考えたか教えてください。",
      "<fadeOut_chara 5 1>   <fadeIn_chara 5 2><item 5>図のように考えました．",
      "赤で囲んだ部分に1本のマッチ棒があって、3本のマッチ棒でできる青のコの字型の部分がn個だけあるから1+3nという式になりました",
      "<fadeOut_chara 5 2><fadeIn_chara 5 1>ありがとうございます。<closeCanvas>では次に(学習者)さんどのように考えたか式を教えてください。<Q5form>",
    ],
    22: [
      "(4+3(n-1))ありがとうございます。",
