window.addEventListener('load', function () {
  ...
  const text = {
    ...
    6: [
      "<item 38>では正方形がn個あるとき、マッチ棒は何本必要ですか。",
      "どのように考えられるでしょうか。まずは4分個人で考えてみてください",
      "<timer>ひょうや図を使って説明できるようにしましょう。<skip 7>",
    ],
    7: [
      "<form 4>",
    ],
    ...
    67: [
      "<itemOut 14>では次にまいさんどのような式を立てたか教えてください<skip 48>"
    ],
    ...
    49: [
      ...
      "<item 47>赤で囲んだ部分に4本のマッチ棒があって、3本のマッチ棒でできる青のコの字型の部分がn-1個だけあるから4+3(n-1)という式になりました<charav 1>",
      "<charaOut 5><itemOut 4><chara 5 1>ありがとうございます。自分の解答と見比べてみましょう。",
      "<root>"
    ],
    50: [
    ...
    60: [
      "<colseapiform><item 48>それぞれ計算すると１+3nになりますね<skip 58>",
    ],
    ...
    61: [
      ...
      "ひょうを使って比較しやすくしましょう。<item 23><form 11>"
    ],
    ...
    72: [
      "<colseapiform><root3>ひょうを縦に見ると、<item 39>マッチ棒の本数は正方形の数を3倍して1足した数になっているという規則性を見つけましたね。",
